...
You can use sesdev to run "make check" in various environments. Use 
...
CAVEAT: by default, the makecheck VM will get 16GB of RAM, and even this
is questionable whether it is sufficient. Tests have been known to fail
due to memory exhaustion in environments with 12GB of RAM.

Let me repeat the admonition: do not try this unless you have plenty of
memory on your libvirtd machine.
